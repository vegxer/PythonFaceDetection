...
class SettingsWindowHOG:
    ...
    def open_dialog(self, root):
        ...
        Label(self.__settings, text="Input upsampling number (from 0 to 4)", font="Arial 11").place(x=5, y=0)
        self.__text_upsampling = Text(self.__settings, width=5, height=1)
    ...
    def __save_settings(self):
        try:
            self.upsampling_number = int(self.__text_upsampling.get("1.0", END))
